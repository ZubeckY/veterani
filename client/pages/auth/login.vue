    ...
    <v-card class="authCard" :disabled="loading">
      <div class="authCard-container">
        ...
        <div class="authCard__header">
          <v-card-title class="authCard-title justify-center px-0">Авторизация</v-card-title>
        </div>
        ...
        <div class="authCard__footer login d-flex align-center justify-center flex-column">
          <v-btn class="authCard-button px-9 mb-2" outlined @click="login">Вход</v-btn>
